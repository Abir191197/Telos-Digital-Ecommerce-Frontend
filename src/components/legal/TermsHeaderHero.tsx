...
import { Clock, ShieldCheck, CheckCircle2, FileText } from "lucide-react";
...
export function TermsHeaderHero() {
  return (
      ...
      <div className="container px-3.5 sm:px-6 max-w-6xl mx-auto">
        ...
        >
          ...
          <m.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 dark:bg-amber-500/15 px-3 py-1 text-[11px] sm:text-xs font-bold text-amber-700 dark:text-amber-300 shadow-2xs backdrop-blur-md"
          >
          ...
          >
            <div className="inline-flex items-center gap-1.5 rounded-lg bg-card/80 dark:bg-zinc-900/80 px-2.5 py-1 sm:px-3 sm:py-1.5 border border-border/70 shadow-2xs">
              ...
              <span>
                Effective: <strong className="text-foreground font-semibold">Sept 2026</strong>
              </span>
            </div>
            <div className="inline-flex items-center gap-1.5 rounded-lg bg-card/80 dark:bg-zinc-900/80 px-2.5 py-1 sm:px-3 sm:py-1.5 border border-border/70 shadow-2xs">
              <ShieldCheck className="h-3.5 w-3.5 text-emerald-500" />
              <span>
                Complies with <strong className="text-foreground font-semibold">Commerce BD</strong>
              </span>
            </div>
            <div className="inline-flex items-center gap-1.5 rounded-lg bg-card/80 dark:bg-zinc-900/80 px-2.5 py-1 sm:px-3 sm:py-1.5 border border-border/70 shadow-2xs">
              <CheckCircle2 className="h-3.5 w-3.5 text-blue-500" />
              <span>
                Binding for <strong className="text-foreground font-semibold">All Buyers</strong>
              </span>
            </div>
          </m.div>
        </m.div>
