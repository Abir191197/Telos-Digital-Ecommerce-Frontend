...
export function AdminWishlistsSkeleton() {
  return (
    <div className="w-full space-y-6 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-2">
          <div className="flex items-center gap-2.5">
            <div className="h-7 w-7 rounded-lg bg-rose-500/20" />
            <div className="h-7 w-56 rounded-lg bg-muted/80" />
          </div>
      ...
      {/* ── 4. Desktop Wishlists Table Skeleton ── */}
            ...
            {Array.from({ length: 8 }).map((_, idx) => (
              ...
              >
                ...
                <div className="w-20 text-right">
                  <div className="h-4 w-14 rounded bg-muted/70 ml-auto" />
                </div>
