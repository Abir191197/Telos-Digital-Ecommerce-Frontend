...
import { ShoppingCart, AlertCircle, TrendingUp, Sparkles, ArrowUpRight } from "lucide-react";
import { cn } from "@/lib/utils";

interface CartKpiStripProps {
...
export function CartKpiStrip({
  ...
  const cards = [
    {
      title: "Active Shopper Carts",
      value: totalActiveCarts.toString(),
      subtext: "Customers actively adding items",
      icon: ShoppingCart,
      iconBg: "bg-emerald-500/10 text-emerald-500",
      pillClass: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",
      pillText: "Live Sessions",
      shimmer: "via-emerald-500/40",
      valueClass: "text-emerald-600 dark:text-emerald-400",
    },
    {
      title: "Abandoned Cart Pipeline",
      value: `৳${abandonedValue.toLocaleString()}`,
      subtext: `${abandonedCount} idle checkouts (>2 hours)`,
      icon: AlertCircle,
      iconBg: "bg-rose-500/15 text-rose-600 dark:text-rose-400",
      pillClass: "bg-rose-500/10 text-rose-600 dark:text-rose-400 font-bold",
      pillText: "Recovery Target",
      shimmer: "via-rose-500/40",
      valueClass: "text-rose-600 dark:text-rose-400",
    },
    {
      title: "High-Ticket Bags (>৳50k)",
      value: highValueCount.toString(),
      subtext: "Prime conversion opportunities",
      icon: Sparkles,
      iconBg: "bg-amber-500/10 text-amber-500",
      pillClass: "bg-amber-500/10 text-amber-600 dark:text-amber-400 font-bold",
      pillText: "VIP Intent",
