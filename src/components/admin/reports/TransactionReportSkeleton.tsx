...
export function TransactionReportSkeleton() {
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-border/40">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <div className="h-5 w-28 rounded-full bg-purple-500/20" />
          </div>
      ...
      {/* ── 2. 4 Transaction KPI Cards Skeleton ── */}
      ...
      {/* ── 3. Desktop Transaction Table Skeleton ── */}
            ...
            {Array.from({ length: 8 }).map((_, idx) => (
              ...
              >
                ...
                <div className="w-32 space-y-1">
                  ...
                  <div className="h-2.5 w-18 rounded bg-muted/40" />
                </div>
