  ...
  return (
    <div className="space-y-10 sm:space-y-14">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {hasMore && (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-foreground text-background hover:bg-amber-500 hover:text-white px-6 py-2.5 text-xs sm:text-sm font-semibold tracking-wide shadow-sm transition-all duration-200 active:scale-[0.98] cursor-pointer"
              >
                <span>Load More</span>
            ...
            {isExpanded && (
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl bg-muted/70 hover:bg-muted text-muted-foreground hover:text-foreground px-4 py-2.5 text-xs sm:text-sm font-medium transition-all active:scale-[0.98] cursor-pointer"
              >
      ...
      {popularProducts.length > 0 && (
        <section aria-label="Most Popular in Categories" className="container px-3 sm:px-6 pt-6">
