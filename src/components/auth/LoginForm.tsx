...
export function LoginForm() {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-background lg:bg-gradient-to-r lg:from-amber-500/[0.04] lg:via-amber-500/[0.01] lg:to-background dark:lg:from-amber-950/15 dark:lg:via-zinc-950 dark:lg:to-background">
      ...
      <div className="pointer-events-none absolute inset-0 select-none overflow-hidden hidden lg:block" aria-hidden="true">
        ...
        <div className="absolute -top-40 -left-40 w-[680px] h-[680px] rounded-full bg-gradient-to-br from-amber-500/8 via-orange-500/4 to-transparent blur-[130px] dark:from-amber-500/6 dark:via-orange-600/3" />
        {/* Secondary mid-left glow bridging across */}
        <div className="absolute top-1/3 -left-20 w-[520px] h-[520px] rounded-full bg-gradient-to-r from-amber-400/6 via-orange-400/2 to-transparent blur-[120px] dark:from-amber-600/4" />
        {/* Soft bottom-left grounding pool */}
        <div className="absolute -bottom-32 -left-20 w-[500px] h-[500px] rounded-full bg-amber-500/3 dark:bg-amber-500/[0.02] blur-[120px]" />
      </div>
          ...
          <div className="lg:col-span-6 xl:col-span-6 flex justify-center lg:justify-end">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-2 space-y-2.5">
                ...
                <GoogleAuthButton text="continue_with" onError={setErrorMessage} />
              </div>
            </form>
