  ...
  return (
    <section aria-label="Express Delivery and Hassle-Free Returns" className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="relative flex flex-col justify-between overflow-hidden rounded-3xl border border-blue-500/20 bg-gradient-to-br from-blue-500/10 via-sky-500/5 to-card p-6 sm:p-7 shadow-xs">
        ...
        <div className="relative flex flex-col justify-between overflow-hidden rounded-3xl border border-amber-500/20 bg-gradient-to-br from-amber-500/10 via-orange-500/5 to-card p-6 sm:p-7 shadow-xs">
          <div className="flex items-start gap-4">
