                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
                  ...
                  <div className="lg:col-span-7 relative z-10 w-full text-left space-y-4 sm:space-y-5 max-w-lg lg:max-w-none">
                    ...
                    <div className="flex flex-wrap items-center justify-start gap-3 pt-2">
                      <Link
                        href={slide.ctaLink}
                        className="inline-flex items-center gap-2 rounded-2xl bg-primary px-6 py-3.5 text-xs sm:text-sm font-bold text-primary-foreground shadow-sm transition-all hover:opacity-90 hover:-translate-y-0.5 active:scale-95"
                      >
                        <span>{slide.ctaText}</span>
                        <ArrowRight className="h-4 w-4 stroke-[2.3]" />
                      </Link>

                      {slide.secondaryCtaText && slide.secondaryCtaLink && (
                        <Link
                          href={slide.secondaryCtaLink}
                          className="inline-flex items-center gap-2 rounded-2xl bg-card/80 backdrop-blur-md px-5 py-3.5 text-xs sm:text-sm font-semibold text-foreground transition-all hover:bg-card hover:shadow-sm hover:-translate-y-0.5"
                        >
