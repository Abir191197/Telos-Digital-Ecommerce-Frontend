...
import { Headphones, PhoneCall, MessageCircle, Clock, ArrowRight } from "lucide-react";
    ...
    <LazyMotion features={domAnimation}>
      <section aria-label="Customer Support Hub" className="w-full">
        <m.div
          ...
          className="group relative overflow-hidden rounded-3xl bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-950 p-6 sm:p-8 text-white shadow-[0_4px_24px_-4px_rgba(0,0,0,0.25)] hover:shadow-[0_12px_40px_-6px_rgba(0,0,0,0.55)] transition-shadow duration-300"
        >
